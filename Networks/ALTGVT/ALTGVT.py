...
class VGG(nn.Module):
    ...
    def init_param(self):
        ...
        self.front_end.load_state_dict(vgg16_bn.features[:13].state_dict())
...
class ALTGVT(PCPVT):
    ...
    alias Twins-SVT
    """
    def __init__(self, img_size=224, patch_size=4, in_chans=128, num_classes=1000, embed_dims=[64, 128, 256],
                 num_heads=[1, 2, 4], mlp_ratios=[4, 4, 4], qkv_bias=False, qk_scale=None, drop_rate=0.,
                 attn_drop_rate=0., drop_path_rate=0., norm_layer=nn.LayerNorm,
