...
class SwinIR(nn.Module):
    ...
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
        ...
        self.conv_first = VGG()
        self.vgg_regression = nn.Sequential(nn.Conv2d(64, 1, 1),
                                            nn.ReLU())
        ...
        self.conv_last = nn.Sequential(nn.Conv2d(embed_dim, embed_dim, 3, padding=2, dilation=2),
                                       nn.BatchNorm2d(embed_dim),
                                       nn.ReLU(inplace=True),
                                       nn.Conv2d(embed_dim, embed_dim, 3, padding=3, dilation=3),
                                       nn.BatchNorm2d(embed_dim),
                                       nn.ReLU(inplace=True),
...
def Net(**kwargs):
    model = SwinIR(img_size=(256, 256), window_size=4, depths=[8, 8, 8, 8],
                   embed_dim=64, num_heads=[8, 8, 8, 8], mlp_ratio=2, **kwargs)
    return model
