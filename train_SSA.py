...
import os
import torch
from train_helper_SSA import Trainer
...
def parse_args():
    ...
    parser.add_argument('--resume', default='/home/xuzhiwen/home/xuzhiwen/dataset_wfs/TransDensityNet/ckpts/ShuntedTrans-STA/4-7-input-256-lr-1e-05-Count/1047_ckpt.tar', type=str,
                        help='the path of resume training model')
    parser.add_argument('--max-epoch', type=int, default=8000,
