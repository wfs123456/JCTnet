...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_path", type=str, default="/home/hdd/dataset_xzw/ShanghaiTech/part_A_final/test_data/images/IMG_104.jpg",
                        help="the image path to be detected.")
    parser.add_argument("--weight_path", type=str, default='/home/xuzhiwen/home/xuzhiwen/dataset_wfs/TransDensityNet/ckpts/VGG1-8-PartA+SwinIR/12-29-input-256-lr-1e-05-Count/best_model_mae 62.20.pth',
